...
from lgd.loader.dataset.abstract_dataset import AbstractDatasetInfos  # AbstractDataModule
...
class SpectreGraphDataset(InMemoryDataset):
    ...
    def raw_file_names(self):
        return [self.dataset_name + 'train.pt', self.dataset_name + 'val.pt', self.dataset_name + 'test.pt']

    @property
    def processed_file_names(self):
            return [self.dataset_name + self.split + '.pt']
